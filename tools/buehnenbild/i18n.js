...
(function (root, factory) {
    ...
    var DE = {
        ...
        'The title sheet': 'Das Titelblatt',
        'The act dividers': 'Die Trennblätter',
        'The scene sheets': 'Die Szenenblätter',
        'The overview': 'Die Übersicht',
        'The prop list': 'Die Requisitenliste',
        'The sheet': 'Das Blatt',
        'Leave out: {sheet}': 'Weglassen: {sheet}',
        '{sheet} stays out. The list on the left brings it back.':
            '{sheet} bleibt weg. In der Liste links kommt es zurück.',
